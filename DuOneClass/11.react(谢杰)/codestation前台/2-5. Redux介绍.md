...
![](https://s2.loli.net/2024/09/06/EaWBUdpjxGkoPb1.png)

此时，我们就需要一个统一的仓库来对组件状态进行管理，如下图：

![](https://s2.loli.net/2024/09/06/dUvBFo8uA3EDhsW.png)
...
![](https://s2.loli.net/2024/09/06/I8iO57oUyRxHvtw.png)

*Redux* 官网：*https://redux.js.org/*

*Redux* 数据流：

![](https://s2.loli.net/2024/09/06/fmwoaN1LKMZyxBD.png)

*Redux* 示例：*ToDoList*

在浏览器中使用 *redux* 扩展工具，首先需要打开谷歌浏览器的扩展应用商店，下载 *redux devtools*

![](https://s2.loli.net/2024/09/06/jx3s1gWbv4uAPfm.png)
...
![](https://s2.loli.net/2024/09/06/sDI4yr3tqMS7HRa.png)
