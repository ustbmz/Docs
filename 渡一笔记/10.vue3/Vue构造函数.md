...
组件实例 ... 只能调用vue3-api中提供的函数

![image-20240121114631020](https://s2.loli.net/2024/01/21/X2ToUf6myln3FPb.png)

# 对比数据响应式

vue2和vue3均在相同的生命周期完成数据响应式，但做法不一样

<img src="https://s2.loli.net/2024/01/21/YfFWplHMt4ETuAS.png" alt="image-20201014155433311" style="zoom:50%;" />
